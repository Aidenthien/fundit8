...
export const mockOrganizations: Organization[] = [
  ...
  },
  {
    ...
    description:
      'Building schools and providing educational resources for underprivileged children worldwide.',
  ...
  },
  {
    ...
    description:
      'Providing immediate assistance to communities affected by natural disasters and humanitarian crises.',
  ...
  },
  {
    ...
    description:
      'Supporting local initiatives to strengthen communities and improve quality of life.',
  ...
  },
  {
    ...
    description:
      'Combating food insecurity through sustainable food systems and emergency relief.',
  ...
  },
  {
    ...
    description:
      'Promoting clean energy solutions and sustainable practices to combat climate change.',
  ...
  },
  {
    ...
    description:
      'Raising awareness and providing resources for mental health support and treatment.',
  ...
  },
  {
    ...
    description:
      'Protecting and caring for animals through rescue operations, shelters, and advocacy.',
...
export const mockCampaigns: Campaign[] = [
  ...
  },
  {
    ...
    organizationId: 'o1',
    description:
      'Installing water purification systems in regions with contaminated water sources.',
    raised: 45,
    goal: 150,
    donors: 72,
    daysLeft: 30,
  ...
  },
  {
    ...
    organizationId: 'o1',
    description:
      'Building community wells to provide sustainable water access in rural areas.',
    raised: 120,
    goal: 120,
    donors: 210,
    daysLeft: 0,
...
export const mockMilestones: Milestone[] = [
  ...
  // Water Purification Systems Milestones
  {
    ...
    description:
      'Research appropriate purification technologies and develop implementation plan',
    amount: 30,
    status: 'completed',
  },
  {
  ...
  },
  {
    ...
    description:
      'Train community members on system maintenance and complete project handover',
    amount: 150,
    status: 'pending',
  },
  ...
  },
  {
    ...
    description:
      'Train community members on well maintenance and water management',
    amount: 120,
    status: 'completed',
  },
];
...
export const mockUpdates: Update[] = [
  {
    ...
    content:
      "We've officially launched the Clean Water Initiative with community meetings in target regions.",
    date: '2023-03-15',
  },
  {
    id: 'u2',
    ...
    content:
      'Our team has completed the initial assessment of water needs in 5 communities.',
    date: '2023-04-10',
  },
  {
    id: 'u3',
    ...
    content:
      'All necessary equipment has been delivered to the project sites and construction will begin next week.',
    date: '2023-05-22',
  },
  {
    id: 'u4',
  ...
  },
  {
    ...
    content:
      "We've placed orders for all necessary purification equipment and expect delivery within two weeks.",
    date: '2023-06-15',
  },
  {
    id: 'u6',
...
export const mockOrganizationLeaderboard: OrganizationLeaderboardEntry[] =
...
export const getDonorDashboardData = (
  donorId: string
): DonorDashboardData | undefined => {
...
export const getDonationsByCampaignId = (
  campaignId: string
): DonationRecord[] => {
...
export const getDonationsByOrganizationId = (
  organizationId: string
): DonationRecord[] => {
  return mockDonations.filter(
    (donation) => donation.organizationId === organizationId
  );
};
...
export const getCampaignsByOrganizationId = (
  organizationId: string
): Campaign[] => {
...
async function getUsernameFromDB(
  address: string
): Promise<{ username: string | null; avatar?: string }> {
  try {
    const origin =
    ...
    const response = await fetch(
      `${origin}/api/users?address=${encodeURIComponent(address)}`
    );
