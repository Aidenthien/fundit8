...
import { ArrowRight, Shield, Heart, BarChart3, Zap, Users, Globe, Clock, Target, Star, Sparkles } from "lucide-react"
          ...
          <div className="container my-auto mx-auto grid place-items-center text-center">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
                ...
                <Typography variant="h6" color="white" className="text-blue-300" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                  About FundIt8
                </Typography>
              </div>

              {/* Main heading with cosmic glow */}
              <Typography variant="h1" color="white" className="lg:max-w-4xl text-6xl md:text-7xl lg:text-8xl font-black" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
              ...
              >
                Fundit8 is dedicated to improving trust, transparency, and efficiency in charitable giving
        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10">
          ...
          <div className="flex flex-col items-center justify-center space-y-6 text-center mb-20">
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
              ...
              <Typography variant="h6" className="text-orange-400 font-medium" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                Our Journey
              </Typography>
            </div>
            <Typography variant="h2" className="text-center text-white text-5xl md:text-6xl lg:text-7xl font-black" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
              <span className="bg-gradient-to-r from-white via-orange-200 to-yellow-200 text-transparent bg-clip-text">
                Our Story
              </span>
            </Typography>
            <Typography className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
              From blockchain enthusiasts to philanthropy advocates, discover how we're revolutionizing charitable giving
            </Typography>
          </div>
          ...
          <div className="space-y-16">
            {[
              ...
              },
              {
                ...
                description: "Fundit8 connects donors with verified organizations around the world, facilitating transparent giving and helping to address some of the world's most pressing challenges.",
                year: "2025+",
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8 z-20">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/30">
                          <Typography color="white" className="font-bold text-sm" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                            {item.year}
                          </Typography>
                        </div>
                      </div>
                      <Typography color="white" className="opacity-90 text-lg font-medium" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                        {item.subtitle}
                      </Typography>
                    </div>
                  </div>
                  ...
                  <div className="group relative bg-gradient-to-r from-gray-800/80 to-gray-900/80 backdrop-blur-sm rounded-3xl p-8 md:p-10 shadow-xl border border-white/10 hover:border-white/20 transition-all duration-500 hover:scale-105 h-full">
                    ...
                    <div className="relative z-10">
                      <div className="flex items-start mb-6">
                        <div className={`bg-${item.color}-900/50 p-4 rounded-2xl mr-6 backdrop-blur-sm border border-${item.color}-500/30 shadow-lg`}>
                        ...
                        <div className="flex-1">
                          ...
                          <Typography className="text-gray-300 text-lg leading-relaxed" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                            {item.description}
                          </Typography>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center mt-6">
                        ...
                        <div className="ml-4 px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                          <Typography className="text-white text-sm font-medium" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                            Step {index + 1}
                          </Typography>
                        </div>
                      </div>
        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10">
          ...
          <div className="space-y-16">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { icon: Shield, color: "blue", title: "Transparency", subtitle: "Complete Visibility", description: "We believe in complete transparency in the donation process. Blockchain technology allows us to provide an immutable record of all transactions and milestone completions.", priority: "Core" },
                { icon: Heart, color: "red", title: "Impact", subtitle: "Maximum Effect", description: "We're committed to maximizing the impact of every donation. Our milestone-based funding approach ensures that resources are used effectively to achieve meaningful outcomes.", priority: "Core" },
                { icon: Users, color: "purple", title: "Community", subtitle: "Global Network", description: "We foster a global community of donors and organizations united by a shared commitment to making a positive difference in the world.", priority: "Core" }
              ].map((value, index) => (
                <div key={index} className="group relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-white/10 hover:border-white/20">
                  ...
                  <div className="relative p-8 md:p-10">
                    <div className="flex items-start justify-between mb-6">
                      <div className={`bg-${value.color}-900/50 p-4 rounded-2xl backdrop-blur-sm border border-${value.color}-500/30 shadow-lg`}>
                        <value.icon className={`h-10 w-10 text-${value.color}-400`} />
                      </div>
                      <div className="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                        <Typography className="text-white text-xs font-medium" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                          {value.priority}
                        </Typography>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <Typography className="text-gray-400 text-sm font-medium" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                          {value.subtitle}
                        </Typography>
                      </div>
                      <Typography className="text-gray-300 leading-relaxed text-lg" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                        {value.description}
                      </Typography>
                    </div>
                  </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { icon: BarChart3, color: "green", title: "Accountability", subtitle: "Trust & Reliability", description: "We hold ourselves and our partner organizations to the highest standards of accountability, ensuring that promises made to donors are kept.", priority: "Supporting" },
                { icon: Zap, color: "yellow", title: "Innovation", subtitle: "Continuous Improvement", description: "We continuously explore new ways to leverage technology to improve the charitable giving experience and increase impact.", priority: "Supporting" },
                { icon: Globe, color: "cyan", title: "Global Reach", subtitle: "Worldwide Impact", description: "We're committed to connecting donors with impactful organizations around the world, regardless of geographic boundaries.", priority: "Supporting" }
              ].map((value, index) => (
                <div key={index} className="group relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-white/10 hover:border-white/20">
                  {/* Glowing border effect */}
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm"></div>
            ...
            <div className="mt-16 text-center">
              <div className="inline-flex items-center gap-4 px-8 py-6 rounded-3xl bg-gradient-to-r from-blue-900/30 via-purple-900/30 to-pink-900/30 backdrop-blur-sm border border-white/20">
                ...
                <Typography className="text-white text-lg font-medium" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10">
          <div className="flex flex-col items-center justify-center space-y-6 text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
              ...
              <Typography variant="h6" className="text-orange-400" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                The People Behind DeNate
              </Typography>
            </div>
            <Typography variant="h2" className="text-center text-white text-4xl md:text-5xl lg:text-6xl font-bold" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
              <span className="bg-gradient-to-r from-white via-orange-200 to-yellow-200 text-transparent bg-clip-text">
                Our Team
              </span>
            </Typography>
            ...
            {[
              ...
              <Card key={index} className="group relative overflow-hidden text-center shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-white/10 hover:border-white/20" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                ...
                <CardBody placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                  <Typography variant="h5" color="white" className="mb-2 font-bold" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                    {member.name}
                  </Typography>
                  <Typography className="text-gray-400 font-medium text-lg" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                    {member.role}
                  </Typography>
                </CardBody>
              </Card>
      ...
      <section className="relative w-full py-24 md:py-32 lg:py-40 bg-gradient-to-br from-blue-950 via-purple-950 to-indigo-950 text-white overflow-hidden">
        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10">
          <div className="flex flex-col items-center justify-center space-y-8 text-center">
            <Typography variant="h2" color="white" className="mb-4 text-4xl md:text-5xl lg:text-6xl font-bold" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
              <span className="bg-gradient-to-r from-white via-blue-200 to-purple-200 text-transparent bg-clip-text">
                Join Our Mission
              </span>
            </Typography>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <Link href="/kyb-form">
                <Button variant="outlined" className="rounded-full bg-transparent border-white/30 text-white hover:bg-white/10 hover:border-white/50 px-8 py-4 text-lg font-bold transition-all duration-300 transform hover:scale-105" placeholder={null} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
